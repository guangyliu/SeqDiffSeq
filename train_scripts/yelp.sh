...
CHECKPOINT_PATH="ckpts/${DSET}/yelp_${SEQ_LEN}_${LR}_${DIFFUSION_STEPS}_${LR_ANNEAL_STEPS}_${WARMUP}_schegran${SCHEDULE_UPDATE_STRIDE}_src${SRC}_tgt${TGT}"
TRAIN_TXT_PATH="./data/yelp/train"
VAL_TXT_PATH="./data/yelp/valid"
IN_CHANNELS=512
WEIGHT_DECAY=0.0
SEED=10708
DROPOUT=0.3
